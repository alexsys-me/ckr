...
document.querySelectorAll('.four-slider').forEach(slider => {
	const wrapper = slider.closest('.four-wp');
	...
	new Swiper(slider, {
		...
		navigation: {
			nextEl: wrapper.querySelector('._arrow-r'),
			prevEl: wrapper.querySelector('._arrow-l'),
		},
...
let testBlock = document.querySelector('.test__block');

if(testBlock ){
	const currentEl = document.querySelector('.test__counter .current');
	const totalEl   = document.querySelector('.test__counter .total');
	new Swiper(testBlock, {
...
function scroll_animate(event) {
 ...
 new Swiper('.card-product__slider', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
thumbs:{
		swiper:{
		el: '.card-product__minis',
		slidesPerView: 4,
		spaceBetween: 12,

		autoHeight: true,
	// 	navigation: {
	// 	nextEl: '.top-model__mini-slider-arr-r',
	// 	prevEl: '.top-model__mini-slider-arr-l',
	// },
		breakpoints: {
 ...
 new Swiper('.content-card-product__color', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.content-card-product__color ._arrows__el-r',
		// prevEl: '.about__more .more__item_prev',
	},
...
let reviewBlock = document.querySelectorAll('.review-block');
let reviewLeft = document.querySelectorAll('.review-slider__left');
let reviewRight = document.querySelectorAll('.review-slider__right');
...
for (let index = 0; index < reviewBlock.length; index++) {
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: reviewRight[index],
		prevEl: reviewLeft[index],
	},
 ...
 new Swiper('.info-product__tovar-block', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.other-prod ._arrows__el-r',
		prevEl: '.other-prod ._arrows__el-l',
	},
 ...
 new Swiper('.info-product__recomendation', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.rec-tovar ._arrows__el-r',
		prevEl: '.rec-tovar ._arrows__el-l',
	},
